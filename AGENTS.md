...
17. Level System Module (Phase 15)
   ...
   * Files Included:
     ...
     * `cogs/level_system/bot_config/`: Sub-directory containing interactive configuration UI components (`main_menu.py`, `role_rewards.py`, `xp_management.py`, `vc_settings.py`, `spam_filters.py`, `cooldown_settings.py`). Employs the Defer Protocol to avoid 3-second modal timeouts.
   * Core Logic & Features:
